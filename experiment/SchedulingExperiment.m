...
classdef SchedulingExperiment < Experiment
    ...
    methods (Access = private)
        ...
        function initVariables(obj)
            ...
            for m = 1:obj.graph.nmeetings
                ...
                for i = unique(graph(:))'
                    ...
                    obj.variable{m,i} = org.anon.cocoa.variables.IntegerVariable(int32(1), int32(obj.nColors), varName);
                    newagent = org.anon.cocoa.agents.VariableAgent(obj.variable{m,i}, agentName);
        ...
        function initEqConstraints(obj)
            peqc = 'org.anon.cocoa.constraints.PreferentialEqualityConstraint';
            constraintCost = 1e3;
            ...
            for m = 1:obj.graph.nmeetings
                ...
                for i = 1:size(graph,1)
                    ...
                    if ~isempty(strfind(obj.iterSolverType, 'MaxSum'))
                        ...
                        obj.constraintAgent{idx} = org.anon.cocoa.agents.BinaryConstraintAgent(agentName, obj.constraint{idx}, obj.variable{m,a}, obj.variable{m,b});
        ...
        function initNeqConstraints(obj)
            neqc = 'org.anon.cocoa.constraints.InequalityConstraint';
            constraintCost = 1e9;
                        ...
                        for m2 = (m1 + 1):obj.graph.nmeetings
                            if ~isempty(obj.agent{m2,a})
                                ...
                                if ~isempty(strfind(obj.iterSolverType, 'MaxSum'))
                                    ...
                                    obj.constraintAgent{idx} = org.anon.cocoa.agents.BinaryConstraintAgent(agentName, obj.constraint{idx}, obj.variable{m1,a}, obj.variable{m2,a});
                                    obj.constraintAgent{idx}.setSolver(feval(functionSolverType, obj.constraintAgent{idx}));
