            ...
            for m = 1:obj.graph.nmeetings
                ...
                for i = 1:size(graph,1)
                    ...
                    if ~isempty(strfind(obj.iterSolverType, 'MaxSum'))
                        ...
                        obj.constraintAgent{idx} = org.anon.cocoa.agents.ConstraintAgent(agentName, obj.constraint{idx}, obj.variable{m,a}, obj.variable{m,b});
                        ...
                        for m2 = (m1 + 1):obj.graph.nmeetings
                            if ~isempty(obj.agent{m2,a})
                                ...
                                if ~isempty(strfind(obj.iterSolverType, 'MaxSum'))
                                    ...
                                    obj.constraintAgent{idx} = org.anon.cocoa.agents.ConstraintAgent(agentName, obj.constraint{idx}, obj.variable{m1,a}, obj.variable{m2,a});
                                    obj.constraintAgent{idx}.setSolver(feval(functionSolverType, obj.constraintAgent{idx}));
