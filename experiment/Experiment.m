...
classdef (Abstract) Experiment < handle
    ...
    methods
        ...
        function obj = Experiment(edges, options)
            % Parse all options
            obj.initSolverType = getSubOption('org.anon.cocoa.solvers.CoCoASolver', 'char', options, 'initSolverType');
            obj.iterSolverType = getSubOption('', 'char', options, 'iterSolverType');
            obj.constraintType = getSubOption('org.anon.cocoa.constraints.InequalityConstraint', 'char', options, 'constraint', 'type');
        ...
        function run(obj)
            ...
            if ~isempty(obj.iterSolverType)
                ...
                obj.results.evals = org.anon.cocoa.ExperimentControl.getNumberEvals();
                obj.results.msgs = org.anon.cocoa.MailMan.getTotalSentMessages();
            end
        end % RUN
    ...
    methods (Sealed, Access = protected)       
        ...
        function runInitSolver(obj)
            ...
            a.set(org.anon.cocoa.solvers.CoCoSolver.ROOTNAME_PROPERTY, true);
        ...
        function runIterSolver(obj)          
            ...
            while ~obj.doStop(i, countDown)
                ...
                obj.results.evals(i) = org.anon.cocoa.ExperimentControl.getNumberEvals();
                obj.results.msgs(i) = org.anon.cocoa.MailMan.getTotalSentMessages();
