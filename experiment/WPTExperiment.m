...
classdef WPTExperiment < Experiment
    ...
    methods (Access = private)
        ...
        function initReceiverConstraints(obj)
            constraintType = 'org.anon.cocoa.constraints.WPTReceiverConstraint';
        ...
        function initReceiverConstraintAgents(obj)
            ...
            for i = 1:numel(obj.graph.edges)
                ...
                obj.constraintAgent{i} = org.anon.cocoa.agents.HigherOrderConstraintAgent(agentName, obj.constraint{i}, involvedVars);
        ...
        function initSensorConstraints(obj)
            constraintType = 'org.anon.cocoa.constraints.WPTSensorConstraint';
        ...
        function initSensorConstraintAgents(obj)
            ...
            for i = 1:numel(obj.graph.sensorEdges)
                ...
                obj.sensorConstraintAgent{i} = org.anon.cocoa.agents.HigherOrderConstraintAgent(agentName, obj.sensorConstraint{i}, involvedVars);
