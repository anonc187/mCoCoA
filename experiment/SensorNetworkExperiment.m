    ...
    methods (Access = private)
        ...
        function initVariables(obj)
            for i = 1: obj.graph.size
                ...
                obj.batteryVar{i} = org.anon.cocoa.variables.IntegerVariable(int32(1), int32(obj.nColors), batteryVarName);
        ...
        function initSEConstraintAgents(obj)
            ...
            for i = 1:size(obj.graph.edges,1)
                ...
                obj.constraintAgent{i} = org.anon.cocoa.agents.BinaryConstraintAgent(agentName, obj.constraint{i}, obj.variable{a}, obj.variable{b});
        ...
        function initBatteryLifeConstraints(obj)
            constraintType = 'org.anon.cocoa.constraints.LessThanConstraint';
            constraintCost = 1e6;
            for i = 1:obj.graph.size
        ...
        function initBLConstraintAgents(obj)
            ...
            for i = 1:obj.graph.size                
                ...
                obj.batteryConstraintAgent{i} = org.anon.cocoa.agents.BinaryConstraintAgent(agentName, obj.batteryConstraint{i}, obj.variable{i}, obj.batteryVar{i});
