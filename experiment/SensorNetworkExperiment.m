    ...
    methods (Access = private)
        ...
        function initSEConstraintAgents(obj)
            ...
            for i = 1:size(obj.graph.edges,1)
                ...
                obj.constraintAgent{i} = org.anon.cocoa.agents.ConstraintAgent(agentName, obj.constraint{i}, obj.variable{a}, obj.variable{b});
        ...
        function initBLConstraintAgents(obj)
            ...
            for i = 1:obj.graph.size                
                ...
                obj.batteryConstraintAgent{i} = org.anon.cocoa.agents.ConstraintAgent(agentName, obj.batteryConstraint{i}, obj.variable{i}, obj.batteryVar{i});
